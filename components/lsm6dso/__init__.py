...
lsm6dso_ns = cg.esphome_ns.namespace("lsm6dso")
LSM6DSOComponent = lsm6dso_ns.class_(
    "LSM6DSOComponent", cg.PollingComponent, i2c.I2CDevice
)
...
CONFIG_SCHEMA = (
    cv.Schema(
        {
            cv.GenerateID(): cv.declare_id(LSM6DSOComponent),
